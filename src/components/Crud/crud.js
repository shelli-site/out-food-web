...
CRUD.HOOK = {
  /** 刷新 - 之前 */
  beforeRefresh: '刷新 - 之前beforeCrudRefresh',
  /** 刷新 - 之后 */
  afterRefresh: '刷新 - 之后afterCrudRefresh',
  /** 删除 - 之前 */
  beforeDelete: '删除 - 之前beforeCrudDelete',
  /** 删除 - 之后 */
  afterDelete: '删除 - 之后afterCrudDelete',
  /** 删除取消 - 之前 */
  beforeDeleteCancel: '删除取消 - 之前beforeCrudDeleteCancel',
  /** 删除取消 - 之后 */
  afterDeleteCancel: '删除取消 - 之后afterCrudDeleteCancel',
  /** 新建 - 之前 */
  beforeToAdd: '新建 - 之前beforeCrudToAdd',
  /** 新建 - 之后 */
  afterToAdd: '新建 - 之后afterCrudToAdd',
  /** 编辑 - 之前 */
  beforeToEdit: '编辑 - 之前beforeCrudToEdit',
  /** 编辑 - 之后 */
  afterToEdit: '编辑 - 之后afterCrudToEdit',
  /** 开始 "新建/编辑" - 之前 */
  beforeToCU: '开始 "新建/编辑" - 之前beforeCrudToCU',
  /** 开始 "新建/编辑" - 之后 */
  afterToCU: '开始 "新建/编辑" - 之后afterCrudToCU',
  /** "新建/编辑" 验证 - 之前 */
  beforeValidateCU: '"新建/编辑" 验证 - 之前beforeCrudValidateCU',
  /** "新建/编辑" 验证 - 之后 */
  afterValidateCU: '"新建/编辑" 验证 - 之后afterCrudValidateCU',
  /** 添加取消 - 之前 */
  beforeAddCancel: '添加取消 - 之前beforeCrudAddCancel',
  /** 添加取消 - 之后 */
  afterAddCancel: '添加取消 - 之后afterCrudAddCancel',
  /** 编辑取消 - 之前 */
  beforeEditCancel: '编辑取消 - 之前beforeCrudEditCancel',
  /** 编辑取消 - 之后 */
  afterEditCancel: '编辑取消 - 之后afterCrudEditCancel',
  /** 提交 - 之前 */
  beforeSubmit: '提交 - 之前beforeCrudSubmitCU',
  /** 提交 - 之后 */
  afterSubmit: '提交 - 之后afterCrudSubmitCU',
